...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 14 15:30:33 2021

@edited for C65 project 2021

This is a version of vanilla SGD, based on code of ProxSGD.

Information of original authors are given below.
"""
...
def SGD(x, y, x_train, y_train, x_test, y_test, batch_size, LRinit, LRprime, LR_COMP, LBD, MAX_TOTAL_EPOCH,\
        w_list, loss_operation, accuracy_operation, verbose = 1, log_enable = 1):

    """! SGD algorithm
    
    Edit: no information of gradient mapping will be outputed.
    ...
    for v, v0, w, grad in zip(v_list, v0_list, w_list, grad_list):
        ...
        # Iteration update
        ops_update_w.append(w.assign_add(- lr * v - lbd * tf.sign(w)))
    ...
    return w_sol, hist_NumGrad, hist_NumEpoch, hist_TrainLoss, hist_TrainAcc, hist_TestAcc
