...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  9 00:32:23 2021

@edited for C65 project 2021

Modified version for usage of report. An option for adding random noise added.
...
def argParser():
    ...
    #new methods
    ap.add_argument("-r", "--random", required=False,
		help="0: No random noise added. Default.\
    		  1: Add random noise for testing set. \
			  2: Add random noise for training set.\
			  3: Both 1 and 2.\
				")

    #modified, deleted unused algorithm
    ...
    # added, get random option
    prog_option["Random"] = 0
    if args.random:
    	prog_option["Random"] = int(args.random)
